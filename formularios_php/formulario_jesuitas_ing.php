...
<body>
    ...
    <h1>Log in with your Jesuit</h1>
    <form action="validar_ing.php" method="post">
        <label for="nombreJesuita">Jesuit's name</label><br/>
        <input type="text" name="nombreJesuita" placeholder="Jesuit's name"/><br/>
        <label for="codigo">Jesuit Code</label><br/>
        <input type="password" name="codigo" placeholder="Jesuit Code" maxlength="5"/><br/>
